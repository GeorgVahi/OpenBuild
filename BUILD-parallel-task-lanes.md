...
- Status: In progress — M1 implementation/review green; milestone commit pending
...
- Status: Implementation and exact review green; `2.4.0-alpha.1` milestone commit pending
...
- Review: Pending exact high-risk diff review
...
- Status: Pending
- Scope: create/resume/close lane, branch/ref/worktree identity, runner repo routing, lane-local one-writer invariant, discovery и preservation external `protected-user-work`.
- Excludes: automatic integration.
- Implementation mode: TDD-first
- Delegation: bounded-worker, high-risk route.
- Red signal: две worktree lanes не имеют authoritative lifecycle и cleanup/replay.
- Focused green: Windows-supported worktree fixtures + current recovery tests.
