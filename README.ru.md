...
Текущий релиз: `2.2.3` ([закреплённый исходник skill](https://github.com/GeorgVahi/OpenBuild/tree/v2.2.3/plugins/openbuild/skills/build)).
