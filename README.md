...
Current release: `2.2.4` ([pinned skill source](https://github.com/GeorgVahi/OpenBuild/tree/v2.2.4/plugins/openbuild/skills/build)).
...
```powershell
codex plugin marketplace add GeorgVahi/OpenBuild --ref v2.2.4
